...
module.exports = {
	...
	// Join a channel..
	join(channel, delay = null) {
		channel = _.channel(channel);

		var _delay = delay || this._getPromiseDelay();

		// Send the command to the server ..
		return this._sendCommand(_delay, null, `JOIN ${channel}`, (resolve, reject) => {
